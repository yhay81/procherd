...
Live reads expose only records whose cursors are present in the same durable
state snapshot; poll again to observe records that were flushed while that
snapshot was being committed.
